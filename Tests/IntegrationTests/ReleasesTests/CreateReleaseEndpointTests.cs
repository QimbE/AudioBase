...
public class CreateReleaseEndpointTests: BaseIntegrationTest
{
    ...
    [InlineData("20111-12-121")]
    [InlineData("20111-1-12")]
    [InlineData("20111-12-1")]
    ...
    [Fact]
    public async Task CreateReleaseEndpoint_Should_ReturnBadRequest_OnInvalidAuthorId()
    {
        // Arrange
        var jwtProvider = Scope.ServiceProvider.GetRequiredService<IJwtProvider>();
        ...
        var request = new CreateReleaseCommand("Name", "CoverLink", "date", Guid.NewGuid(), 1);
    ...
    public async Task CreateReleaseEndpoint_Should_ReturnBadRequest_OnInvalidTypeId()
    {
        ...
        var request = new CreateReleaseCommand("Name", "CoverLink", "date", _author.Id, 10000);
